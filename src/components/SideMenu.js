        ...
        return (
            <div key='sidemenu' className={classes}>
                <span className='pure-menu-heading main-heading'>
                    <Link className='heading' to='/' onClick={this.props.actions.closeMenu}>
                        Workout Tracker
                    </Link>
                </span>
                <ul className='pure-menu-list'>
                    <li className='pure-menu-item'>
                        <Link to='/' className='pure-menu-link' activeClassName='active' onClick={this.props.actions.closeMenu}>
                            Home
                        </Link>
                    </li>
                    {loginLinks}
